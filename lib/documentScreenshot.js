...
module.exports = function documentScreenshot(fileName) {
    ...
    var self = this.instance,
        ...
        scrollFn = function(w, h) {
            ...
            html.style.webkitTransform = 'translate(-' + w + 'px, -' + h + 'px)';
            html.style.mozTransform = 'translate(-' + w + 'px, -' + h + 'px)';
            html.style.msTransform = 'translate(-' + w + 'px, -' + h + 'px)';
            html.style.oTransform = 'translate(-' + w + 'px, -' + h + 'px)';
            html.style.transform = 'translate(-' + w + 'px, -' + h + 'px)';
        };
