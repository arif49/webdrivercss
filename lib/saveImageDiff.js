...
module.exports = function (imageDiff, done) {
    ...
    var that = this,
        misMatchTolerance = parseFloat(imageDiff.misMatchPercentage);
    ...
    if (this.misMatchTolerance < misMatchTolerance) {
        ...
        this.self.resultObject[this.currentArgs.name].push({
            ...
            message: 'mismatch tolerance (+' + misMatchTolerance + ') exceeded configured tolerance (+' + (this.misMatchTolerance) + '), image-diff created',
